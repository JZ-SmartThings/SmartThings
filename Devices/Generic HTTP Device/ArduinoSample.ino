/**
 *  Arduino / ESP8266-12E / NodeMCU Sample v1.0.20160603
...
void loop() {
  ...
  client.println("<html><head><title>ESP8266 Dual Relay</title></head><meta name=viewport content='width=500'><style type='text/css'>button {line-height: 2.2em; margin: 10px;} body {text-align:center;}");
