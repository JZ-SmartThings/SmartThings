...
metadata {
	...
	tiles(scale: 2) {
		...
		main "DeviceTrigger"
		details(["displayName","mainTriggered", "DeviceTrigger", "customTriggered", "CustomTrigger", "refreshTriggered", "RefreshTrigger", "cpuUsage", "cpuTemp", "upTime", "spaceUsed", "freeMem", "clearTiles", "temperature", "humidity" , "contact", "RebootNow"])
	}
}
